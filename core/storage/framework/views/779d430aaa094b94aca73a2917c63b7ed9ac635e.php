    ...
    <section class="pt-50 pb-50 contact-section overflow-hidden section--bg">
        ...
        <div class="container">
            <div class="row justify-content-center mt-4">
                <div class="col-lg-8">
                    <form class="create-company-form" action="<?php echo e(route('user.company.store')); ?>" method="post"
                        enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="custom--card">
                            <div class="card-header bg--dark">
                                <h5 class="text-white"><?php echo app('translator')->get('Provide Your Company Information'); ?></h5>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="profile-thumb justify-content-center">
                                                <div class="avatar-preview">
                                                    <div class="profilePicPreview" style="background-image: url('<?php echo e(getImage('', getFileSize('company'))); ?>');"> </div>
                                    ...
                                    <div class="col-lg-6 form-group">
                                        ...
                                        <input type="url" name="url" class="form--control" value="<?php echo e(old('url')); ?>" required>
                                    </div>
                                    ...
                                    <div class="col-lg-6 form-group">
                                        <div class="position-relative">
                                            ...
                                            <small class="tag-text"><?php echo app('translator')->get('Separate multiple keywords by'); ?> <code>,</code>(<?php echo app('translator')->get('comma'); ?>) <?php echo app('translator')->get('or'); ?> <code><?php echo app('translator')->get('enter'); ?></code> <?php echo app('translator')->get('key'); ?></small>
                                        </div>
                                    </div>
...
<?php echo $__env->make($activeTemplate.'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fxbrizdp/public_html/core/resources/views/templates/basic/user/company/form.blade.php ENDPATH**/ ?>