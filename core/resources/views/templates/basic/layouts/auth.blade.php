...
<head>
    ...
    <link rel="icon" type="image/png" href=" {{ getImage(getFilePath('logoIcon'). '/favicon.png') }}" sizes="16x16" alt="{{ __($general->site_name) }}">
  ...
  <link rel="stylesheet" href="{{ asset($activeTemplateTrue . 'css/main.css') }}">
   ...
   <link rel="stylesheet" href="{{ asset($activeTemplateTrue . 'css/color.php') }}?color={{ $general->base_color }}&secondColor={{$general->secondary_color}}" rel="stylesheet">
