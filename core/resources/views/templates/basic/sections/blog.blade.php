                    ...
                    <div class="blog-post rounded-3">
                        ...
                        <div class="blog-post__content">
                            <h5 class="blog-post__title">
                                <a href="{{ route('blog.details', [slug($blog->data_values->title),$blog->id]) }}"> {{ __(strLimit($blog->data_values->title, 80)) }}</a>
                            </h5>
                            <p class="mt-2">
                                @php echo __(strLimit(strip_tags($blog->data_values->description), 90));@endphp
                            </p>
                            <a href="{{ route('blog.details', [slug($blog->data_values->title),$blog->id]) }}" class="blog-post__btn mt-3">
