                ...
                <div class="col-lg-12">
                    <div class="contact-wrapper d-flex flex-wrap">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 form-group">
                                        ...
                                        <div class="custom-icon-field">
                                            ...
                                            <input type="text" name="name" value="{{ old('name') }}"
                                                autocomplete="off" class="form--control" placeholder="@lang('Full name')"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 form-group">
                                        ...
                                        <div class="custom-icon-field">
                                            ...
                                            <input type="text" name="email" value="{{ old('email') }}"
                                                autocomplete="off" class="form--control" placeholder="@lang('Email address')"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 form-group">
                                        ...
                                        <div class="custom-icon-field">
                                            ...
                                            <input type="text" name="subject" value="{{ old('subject') }}"
                                                autocomplete="off" class="form--control" placeholder="@lang('Subject Line')"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 form-group">
                                        ...
                                        <div class="custom-icon-field">
                                            ...
                                            <textarea name="message" autocomplete="off" class="form--control" wrap="off" placeholder="@lang('Write message')"
                        ...
                        <div class="contact-wrapper__right">
                            ...
                            <div class="top-part">
                                <h3 class="title text-white">{{ __(@$content->data_values->title) }}</h3>
