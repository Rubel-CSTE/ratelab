                ...
                <div class="col-lg-4 col-md-12 col-sm-6">
                    <div class="footer-widget">
                        <a class="site-logo site-title" href="{{ route('home') }}">
                            <img src="{{getImage(getFilePath('logoIcon') .'/logo.png', '100X100')}}" alt="{{ __($general->site_name) }}">
                        </a>
                            ...
                            @foreach ($policyPages as $page)
                                <li>
                                    <a class="t-link t-link--danger text--white"
                                        href="{{ route('policy.pages', [slug($page->data_values->title), $page->id]) }}">{{ @$page->data_values->title }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
