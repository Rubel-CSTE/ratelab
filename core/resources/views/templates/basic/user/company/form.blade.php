                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="profile-thumb justify-content-center">
                                                <div class="avatar-preview">
                                                    <div class="profilePicPreview" style="background-image: url('{{ getImage('', getFileSize('company')) }}');"> </div>
                                    ...
                                    <div class="col-lg-6 form-group">
                                        <div class="position-relative">
                                            ...
                                            <small class="tag-text">@lang('Separate multiple keywords by') <code>,</code>(@lang('comma')) @lang('or') <code>@lang('enter')</code> @lang('key')</small>
                                        </div>
                                    </div>
