                ...
                <div class="card custom--card">
                    ...
                    <div class="card-body">
                        <form  action="{{route('ticket.store')}}"  method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <button class="btn btn--base w-100" type="submit"><i class="la la-paper-plane"></i>&nbsp;@lang('Submit')</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            $('.addFile').on('click',function(){
                ...
                $("#fileUploadsContainer").append(`
                    <div class="input-group my-3">
                        ...
                        <span class="input-group-text btn-danger remove-btn"><i class="la la-times"></i></span>
                    </div>
                `)
            });
