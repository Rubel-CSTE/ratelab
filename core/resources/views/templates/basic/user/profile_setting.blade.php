                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-icon-field">
                                ...
                                <input type="text" name="firstname" class="form--control"
                                    placeholder="{{ __($user->firstname) }}" value="{{ __($user->firstname) }}" required>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="custom-icon-field">
                            ...
                            <input type="email" class="form--control" placeholder="{{ __($user->email) }}"
                                value="{{ __($user->email) }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="custom-icon-field">
                            ...
                            <input type="text" name="address" class="form--control"
                                placeholder="{{ __($user->address->address) }}" value="{{ __($user->address->address) }}">
                        </div>
                    </div>
                    <div class="col-lg-6 form-group">
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="custom-icon-field">
                            ...
                            <input type="text" name="state" class="form--control"
                                placeholder="{{ __($user->address->state) }}" value="{{ __($user->address->state) }}">
                        </div>
                    </div>
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="custom-icon-field">
                            ...
                            <input type="text" name="city" class="form--control"
                                placeholder="{{ __($user->address->city) }}" value="{{ __($user->address->city) }}">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 form-group">
                        ...
                        <div class="custom-icon-field">
                            ...
                            <textarea name="about" class="form--control" placeholder="@lang('Write about....')">{{ __($user->about) }}</textarea>
                        </div>
                    </div>
