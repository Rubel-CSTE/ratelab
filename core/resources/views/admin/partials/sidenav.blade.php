    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.category.index')}}">
                  ...
                  <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.company*',3)}}">
                        ...
                        <span class="menu-title">@lang('Companies')</span>
                        ...
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.company.index')}} ">
                                <a href="{{route('admin.company.index')}}" class="nav-link">
                                    ...
                                    <span class="menu-title">@lang('All Companies')</span>
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.company.pending')}} ">
                                <a href="{{route('admin.company.pending')}}" class="nav-link">
                                    ...
                                    @if($pendingCompaniesCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{$pendingCompaniesCount}}</span>
                                    @endif
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.review.index')}}">
                    <a href="{{route('admin.review.index')}}" class="nav-link"
                       data-default-url="{{ route('admin.review.index') }}">
